window.onload = function() {
    ...
    const filenames = [
        "https://github.com/LauraRuis/lauraruis.github.io/blob/master/Demo/Data/answer_and_slope_pretraining_data_prepared_35B.json",
        "https://github.com/LauraRuis/lauraruis.github.io/blob/master/Demo/Data/answer_and_slope_pretraining_data_prepared_7B.json"];
    ...
    infoContainer.append("p")
        .text("NB: for now we only loaded 80 pretraining documents here with answers to questions and slope procedures. This means not every query has relevant documents from the top or bottom yet.")
    infoContainer.append("p")
        .text("However, most slopes questions have relevant documents (all for the 35B, most for the 7B). Some factual questions have relevant documents. Click for example on query idx 0 for the 7B or query idx 35 for the 35B and sort by rank (0 is the highest).")
    infoContainer.append("p")
    ...
    infoContainer.append("h4")
        .text("Query set indices")
    infoContainer.append("h5")
        .text("  Factual: 0 - 39")
        .style("color", "#A189C5",)
    infoContainer.append("h5")
        .text("Reasoning: 40 - 79")
        .style("color", "#6E9594")
    infoContainer.append("h6")
        .text("Arithmetic (7B): 40 - 59")
        .style("color", "#6E9594")
    infoContainer.append("h6")
        .text("Linear (35B): 40 - 59")
        .style("color", "#6E9594")
        infoContainer.append("h6")
        .text("Slopes (7B and 35B): 60 - 79")
        .style("color", "#6E9594")
    infoContainer.append("h5")
        .text("Factual control: 80 - 89")
        .style("color", "#F5D45F")
    infoContainer.append("h5")
        .text("Reasoning control: 90 - 99")
        .style("color", "#FFAC72")
    // URL to blog
    infoContainer.append("h4")
    ...
    function getData(error, jsons) {
        ...
        makeTrainTable(firstQuery["35B"], documents, "documents_table",
            "Influence score (normalised)", "35B");
