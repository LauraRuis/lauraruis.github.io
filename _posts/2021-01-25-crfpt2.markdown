...
marginals (which are needed for the gradients). PyTorch takes care of the latter calculation for us (`<3` PyTorch).
...
figure out how to do that in Google drawings `:D`.
