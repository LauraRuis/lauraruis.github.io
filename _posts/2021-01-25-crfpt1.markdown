...
we don't need to hand-engineer such feature functions anymore and can hit it with the DL hammer `:)` (which we will cover in [part 2]({% post_url 2021-01-25-crfpt2 %}) of this series).
