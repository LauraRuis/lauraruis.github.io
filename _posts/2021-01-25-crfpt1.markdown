---
layout: post
title:  "Structured Prediction part one - Deriving a Linear-chain CRF"
usemathjax: true
---
...
LSTM and in [part three]({% post_url 2021-11-06-crfpt3 %}) train it all end-to-end on a POS tagging dataset.
OK! Let's start.
...
like LSTM's, and train everything end-to-end with stochastic gradient ascent on the likelihood! All part of [part two]({% post_url 2021-01-25-crfpt2 %}) and [part three]({% post_url 2021-11-06-crfpt3 %}) of this series.
