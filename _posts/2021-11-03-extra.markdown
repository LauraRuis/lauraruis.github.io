...
*We shouldn't use interpolation/extrapolation when talking about generalization, because for high dimensional data deep learning models are
...
that actually align with generalization in the context of high dimensional data. So let's dive in!
...
Subject to the constraints that the $$\lambda_i$$'s are nonnegative and sum to one: $$\lambda_i \geq 0$$ and $$\sum_i \lambda_i = 1$$.
...
<img src="/images/2d_convexhull.png" alt="2d_convexhull" width="400" class="center"/>
...
<img src="/images/3d_convexhull.png" alt="3d_convexhull" width="400" class="center"/>
...
<img src="/images/evolution_N.png" alt="evolution_N" width="400" class="center"/>
...
<img src="/images/first_plot.png" alt="firstplot" width="400" class="center"/>
...
<img src="/images/gauss_samples.png" alt="gaussamples" width="400" class="center"/>
...
Gaussian $$\mathcal{N}(\mathbf{0}, \mathbb{I}_d)$$. These points form the convex hull. Then we sample 500000 new points (`num_trials`) 
...
<img src="/images/left_plot.png" alt="leftplot" width="800" class="center"/>

Jippie[^1]! There it is! So beautiful. Very reproduce. Much similar. 
...
<img src="/images/second_plot.png" alt="secondplot" width="300" class="center"/>
...
<img src="/images/1d_manifold.png" alt="1d_manifold" width="800" class="center"/>
...
Instead, we will frame it as a quadratic programming problem[^2] and solve it with a QP solver that can handle degeneracy. 
...
<img src="/images/middle_plot.png" alt="middleplot" width="800" class="center"/>

We can see that even though we cheated by only sampling the data points once per ambient dimension, and
only doing 100 Monte-Carlo trials instead of 500000, we get away with it!

## <span style="color:#C0392B">Reproducing the Final Plot</span>
> **_In this section:_**  Convex Hull Dimension

<img src="/images/third_plot.png" alt="thirdplot" width="300" class="center"/>
...
<img src="/images/convexhull_ds.png" alt="convexhull_ds" width="800" class="center"/>
...
<img src="/images/right_plot_repro.png" alt="right_plot_repro" width="700" class="center"/>
...
one answer. Perhaps there are more.

# <span style="color:#C0392B">Disclaimers</span>

I don't claim to fully understand what is going on in this paper still, and the methods I used to obtain data with certain
...
[^1]: Jippie means "Yippie" in Dutch.
[^2]: You could also <a href="https://math.stackexchange.com/questions/1511112/test-if-point-is-in-convex-hull-of-n-points" target="_blank">frame it as a linear programming problem.</a>

# Todo's
- Alt text for images
- Check intuition with email from Randall
- Clean code and put on github and add link
